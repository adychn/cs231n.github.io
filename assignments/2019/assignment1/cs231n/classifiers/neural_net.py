...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        # dW2
        # the vector related to w11 is xi1 = part of Ci1, and w21 is xi2 = part of Ci1...so on
        dW2 = a1.T.dot(softmax) # [HxN] * [NxC] = [HxC]
        ...
        # dW1
        da1 = softmax.dot(W2.T) * (a1 > 0)  # [NxC] * [CxH] . [NxH] = [NxH], softmax loss needs to be weighted
                                            # by W2 before propagates back...
        dW1 = X.T.dot(da1)                   # [DxN] * [NxH] = [DxH]
